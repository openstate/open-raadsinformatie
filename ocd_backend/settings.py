...
AUTORETRY_RETRY_BACKOFF = 5
RETRY_MAX_RETRIES = 2 # 9 RVD temporarily set lower to speed up overall reindexing
...
MARKDOWN_VERSION = f"PyMuPDF==1.27.2.3-pymupdf4llm==0.3.4"
