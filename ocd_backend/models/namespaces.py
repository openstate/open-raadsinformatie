...
COUNCIL = Namespace('https://argu.co/ns/0.1/gov/council#', 'council')
GOVID = Namespace('https://argu.co/ns/0.1/gov/id#', 'govid')
META = Namespace('https://argu.co/ns/0.1/meta#', 'meta')
