...
class BaseLoader(OCDBackendTaskSuccessMixin, OCDBackendTaskFailureMixin,
    ...
    def run(self, *args, **kwargs):
        ...
        return self.load_item(combined_object_id, object_id, combined_index_doc, doc)
...
class ElasticsearchLoader(BaseLoader):
    ...
    def load_item(self, combined_object_id, object_id, combined_index_doc, doc):
        ...
        elasticsearch.index(index=settings.COMBINED_INDEX, doc_type='item',
                            id=combined_object_id, body=combined_index_doc)
...
class DummyLoader(BaseLoader):
    ...
    """
    def load_item(self, combined_object_id, object_id, combined_index_doc, doc, transformer_task_id):
        print '=' * 50
