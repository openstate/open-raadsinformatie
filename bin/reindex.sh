#!/bin/bash
# This script will reindex all sources listed in $TO_INDEX_FILENAME. It is
# run periodically by crontab to see if the next source can be started.
#
...
function warn_processing_time() {
    ...
    SUBJECT="Processing $locked_source is taking too long"
